...
generate_P_R_F_plots(avg_data_garvan, avg_size_garvan(2:end,:))
generate_P_R_F_plots(avg_data_HS01, avg_size_HS01(2:end,:))
generate_P_R_F_plots(avg_data_iontorrent, avg_size_iontorrent(2:end,:))
